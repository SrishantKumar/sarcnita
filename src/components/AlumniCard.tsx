  ...
  return (
    ...
    >
      ...
      <div className="p-4 xs:p-5 sm:p-6">
        ...
        <p className="text-sm xs:text-base text-gray-600 mt-1">{position}</p>
        <p className="text-xs xs:text-sm text-gray-500 mt-1">Batch of {batch}</p>
        <p className="text-sm xs:text-base text-gray-600 mt-1">{company}</p>
        <div className="mt-3 xs:mt-4 flex flex-wrap gap-3 xs:gap-4">
